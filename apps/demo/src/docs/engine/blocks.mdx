...
- **Shape** â€” defines geometry (`rect`, `ellipse`, `line`, `arrow`, `polygon`, `star`)
- **Fill** â€” defines appearance (`solid-color`, `image`)
- **Effects** â€” stackable effects (`adjustments`, `filter`)
