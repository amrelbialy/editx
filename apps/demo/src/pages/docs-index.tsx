...
const SECTIONS = [
  ...
  },
  {
    ...
    description: "Tailor which tools appear and extend the editor with your own UI.",
    links: [
      ...
      { label: "Configure the Filter Tool", href: "/docs/image-editor/guides/configure-filters" },
      { label: "Configure Text Fonts", href: "/docs/image-editor/guides/configure-fonts" },
      { label: "Configure the Shapes Tool", href: "/docs/image-editor/guides/configure-shapes" },
      {
      ...
      { label: "Compact the Tool Sidebar", href: "/docs/image-editor/guides/compact-sidebar" },
  ...
  {
    title: "Export & Events",
    description: "Control output formats and react to what users do in the editor.",
    links: [
