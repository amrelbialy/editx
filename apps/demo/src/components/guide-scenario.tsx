...
interface GuideScenarioProps {
  /** The guide's config — rendered live on the sample image. */
...
/**
 * Renders a live, inline ImageEditor for a documentation guide. The same
 * config shown in the guide's code block is applied here so readers can try it
 * immediately. The guide's own `theme` (if any) wins; otherwise the demo's
 * light/dark preset is used.
 */
export function GuideScenario(props: GuideScenarioProps) {
