...
| 4   | Adjustments (Full Suite) | **in progress**                 | adjustment properties (12 params), Konva filter pipeline          | adjustment panel with Basic & Refinements    | `docs/features/04-adjustments.md` |
