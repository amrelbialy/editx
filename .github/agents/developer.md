...
## Procedure
1. Read `CLAUDE.md` + `docs-private/FEATURE_MAP.md`; locate existing patterns near the change (search before writing).
...
5. Update `docs-private/FEATURE_MAP.md` when a feature lands/moves/is removed.
