...
- **Tailwind-first responsive**: Use CSS Container Queries (`@container/editor` + `@md/editor:`) — never viewport breakpoints or JS detection.
...
- **No `console.log`** in production code — gate behind `__CE_PERF` flag.
