...
>(
  (
    { className, align = "center", sideOffset = 4, onOpenAutoFocus, onCloseAutoFocus, ...props },
    ref,
  ) => {
    ...
    return (
      <PopoverPrimitive.Portal container={container}>
        <PopoverPrimitive.Content
          ...
          className={cn(
            "z-50 w-64 rounded-lg border border-border bg-card p-4 shadow-md outline-none",
